...
describe('Breed Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'breed', component: BreedComponent }]), HttpClientTestingModule],
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.breeds?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });

  describe('trackId', () => {
    it('Should forward to breedService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getBreedIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getBreedIdentifier).toHaveBeenCalledWith(entity);
